...
This document is a modified version of one found in [https://cognitect.com/blog/2011/11/15/documenting-architecture-decisions](https://cognitect.com/blog/2011/11/15/documenting-architecture-decisions). The only significant change is on the topic of filenames, minor formatting changes, and the experience report.
...
We will keep ADRs in the project repository under `docs/adrs/adr-NNN-xxx.md` where `xxx` is a shortened form of the title, or the title itself if it is short enough. Use underscores (`_`) in place of spaces in the title.

e.g. `docs/adrs/adr-000-documenting_architecture_decisions.md`.

Including a short title in the filename allows humans to more easily browse through the list of ADRs, and finding the relevant one.
...
The experience report below is preserved in its original form in markdown's quote syntax, as it was written by Michael Nygard in Cognitect. This is an entirely unrelated individual who works or has worked at an unrelated organization. This note exists to distinguish the rest of the document (which is perspective-agnostic) from the personal experiences of the original author, as it may confuse readers of this document into thinking that "we" is the organization adoping this ADR.

> You may have noticed that this post is formatted like an ADR itself. That's not a very long time in the global sense, but early feedback from both clients and developers has been quite positive. In that time, we've had six to ten developers rotate through projects using ADRs. All of them have stated that they appreciate the degree of context they received by reading them.
